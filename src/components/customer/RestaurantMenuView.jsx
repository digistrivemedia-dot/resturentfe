    ...
    return (
      <div className="py-4 min-h-screen">
        <div className="flex items-center gap-3 mb-6">
          <Link href={backHref} className="p-1.5 rounded-[var(--radius-md)] text-text-secondary hover:bg-bg-hover transition-colors">
            <ArrowLeft size={20} />
          </Link>
  ...
  if (!restaurant) {
    return (
      <div className="py-4 min-h-screen flex flex-col items-center justify-center">
        ...
        <Link href={backHref} className="text-sm font-semibold text-primary hover:underline">Go back</Link>
      </div>
    );
  }
